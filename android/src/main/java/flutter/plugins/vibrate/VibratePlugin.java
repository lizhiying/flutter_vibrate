 ...
 * VibratePlugin
 */
public class VibratePlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
    ...
    _vibrator = (Vibrator) mContext.getSystemService(Context.VIBRATOR_SERVICE);
    channel = new MethodChannel(binding.getBinaryMessenger(), "vibrate");
